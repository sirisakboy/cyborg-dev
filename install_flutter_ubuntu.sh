#!/bin/bash
# Flutter Installation Script for Ubuntu/Debian/Kali Linux

set -e

echo -e "\e[34m====================================\e[0m"
echo -e "\e[34m  Flutter Installation for Ubuntu/Debian/Kali\e[0m"
echo -e "\e[34m====================================\e[0m"
...
sudo apt install -y curl git wget unzip zip libgl1-mesa-dev xz-utils liblz4-tool clang
...
# Set up Android SDK
echo -e "\e[33mSetting up Android SDK...\e[0m"
mkdir -p ~/android/sdk
...
echo -e "\e[33m1. Restart your terminal\e[0m"
