#!/bin/bash
# Flutter Installation Script for Fedora

set -e

echo -e "\e[34m====================================\e[0m"
echo -e "\e[34m    Flutter Installation for Fedora\e[0m"
echo -e "\e[34m====================================\e[0m"
...
sudo dnf install -y curl git wget unzip zip which libglvnd-glx xz lz4 clang
